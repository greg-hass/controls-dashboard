...
export const mockServices: Service[] = [
  { PK: 'tiktok', name: 'TikTok', category: 'social', status: 0, locations: ['LON', 'YYZ', 'JFK'] },
  { PK: 'instagram', name: 'Instagram', category: 'social', status: 0, locations: ['LON', 'YYZ', 'JFK'] },
  { PK: 'facebook', name: 'Facebook', category: 'social', status: 0, locations: ['LON', 'YYZ', 'JFK'] },
  { PK: 'twitter', name: 'X / Twitter', category: 'social', status: 1, locations: ['LON', 'YYZ', 'JFK'] },
  { PK: 'snapchat', name: 'Snapchat', category: 'social', status: 0, locations: ['LON', 'YYZ', 'JFK'] },
  { PK: 'youtube', name: 'YouTube', category: 'streaming', status: 1, locations: ['LON', 'YYZ', 'JFK'] },
  { PK: 'netflix', name: 'Netflix', category: 'streaming', status: 1, locations: ['LON', 'YYZ', 'JFK'] },
  { PK: 'spotify', name: 'Spotify', category: 'streaming', status: 1, locations: ['LON', 'YYZ', 'JFK'] },
  { PK: 'twitch', name: 'Twitch', category: 'streaming', status: 0, locations: ['LON', 'YYZ', 'JFK'] },
  { PK: 'steam', name: 'Steam', category: 'gaming', status: 0, locations: ['LON', 'YYZ', 'JFK'] },
  { PK: 'epic', name: 'Epic Games', category: 'gaming', status: 0, locations: ['LON', 'YYZ', 'JFK'] },
  { PK: 'roblox', name: 'Roblox', category: 'gaming', status: 0, locations: ['LON', 'YYZ', 'JFK'] },
  { PK: 'discord', name: 'Discord', category: 'communication', status: 1, locations: ['LON', 'YYZ', 'JFK'] },
  { PK: 'zoom', name: 'Zoom', category: 'communication', status: 1, locations: ['LON', 'YYZ', 'JFK'] },
  { PK: 'teams', name: 'Microsoft Teams', category: 'communication', status: 1, locations: ['LON', 'YYZ', 'JFK'] },
  { PK: 'amazon', name: 'Amazon', category: 'shopping', status: 1, locations: ['LON', 'YYZ', 'JFK'] },
  { PK: 'ebay', name: 'eBay', category: 'shopping', status: 1, locations: ['LON', 'YYZ', 'JFK'] },
  { PK: 'coursera', name: 'Coursera', category: 'education', status: 1, locations: ['LON', 'YYZ', 'JFK'] },
  { PK: 'khan', name: 'Khan Academy', category: 'education', status: 1, locations: ['LON', 'YYZ', 'JFK'] },
  { PK: 'reddit', name: 'Reddit', category: 'social', status: 1, locations: ['LON', 'YYZ', 'JFK'] },
];
